Cohorts = (function() {
    ...
    var Test = (function() {        
        ...
        var constructor = function(options) {
            ...
            if(!this.options.storageAdapters)
                this.options.storageAdapters = [GoogleAnalyticsAdapter];
        ...
        constructor.prototype = {
            run: function() {
                ...
                if(in_test) {
                    ...
                    for (var adapter = 0; adapter < this.options.storageAdapters.length; adapter++)
                        this.options.storageAdapters[adapter].onInitialize(in_test, this.options.name, chosen_cohort);
            ...
            event: function(eventName) {
                if(this.inTest())
                    for (var adapter = 0; adapter < this.options.storageAdapters.length; adapter++)
                        this.options.storageAdapters[adapter].onEvent(this.options.name, this.getCohort(), eventName);
            },
            inTest: function() {
